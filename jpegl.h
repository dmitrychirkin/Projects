...
/* encoder.c */
/*
extern int jpgl_encode_mem(unsigned char **, int *, IMG_DAT *, char *);
...
extern int putc_huffman_table(unsigned short *, const unsigned char,
...
//extern int setup_frame_header_jpegl_jpegl(FRM_HEADER_JPEGL **, IMG_DAT *);
extern int read_frame_header_jpegl_jpegl(FRM_HEADER_JPEGL **, FILE *);
extern int getc_frame_header_jpegl_jpegl(FRM_HEADER_JPEGL **, unsigned char **,
                   unsigned char *);
extern int write_frame_header_jpegl_jpegl(FRM_HEADER_JPEGL *, FILE *);
extern int putc_frame_header_jpegl_jpegl(FRM_HEADER_JPEGL *, unsigned char *,
                   const int, int *);
...
/* HERE: ioutil.c to be removed */
extern int newext(char *, int, char *);
